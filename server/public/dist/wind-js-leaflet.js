...
L.Control.WindPosition = L.Control.extend({
	...
	mpsToKmh: function mpsToKmh(mps) {
		return mps * 3.6;
	},
	...
	_onMouseMove: function _onMouseMove(e) {
		...
		if (gridValue && !isNaN(gridValue[0]) && !isNaN(gridValue[1]) && gridValue[2]) {
			...
			htmlOut = "<strong>Wind Direction: </strong>" + self.vectorToDegrees(gridValue[0], vMs) + "°" + ", <strong>Wind Speed: </strong>" + (self.mpsToKmh(self.vectorToSpeed(gridValue[0], vMs)).toFixed(1)) + "km/h" + ", <strong>Temp: </strong>" + (gridValue[2] - 273.15).toFixed(1) + "°C";
		} else {
